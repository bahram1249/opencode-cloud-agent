(function () {
  ...
  window.showAddProjectModal = function (wsId) {
    ...
    var bodyHtml = ''
      ...
      + '</div>'
      + '<div class="form-group">'
      + '  <label class="form-label">Path (relative to workspace root)</label>'
      + '  <input type="text" class="form-input" id="proj-path" placeholder="e.g. apps/backend or . for workspace root" value="." autocomplete="off">'
      + '  <div class="form-hint">Use "." for the workspace root directory.</div>'
