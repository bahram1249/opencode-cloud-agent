...
Mini App browser-based UI providing the same functionality as the Telegram bot — workspace management, project management, terminal access, git operations, and session management — via hash-based routing and REST API + WebSocket communication.
