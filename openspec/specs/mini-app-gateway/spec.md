...
WebSocket gateway providing real-time bidirectional communication between the Mini App terminal (xterm.js) and the PTY running inside the workspace container.
...
#### Scenario: Authenticated WebSocket connection with initData
